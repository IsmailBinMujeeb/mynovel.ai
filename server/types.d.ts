...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'api.form.update': ApiRouteHandler<{ answer: string }, ApiResponse<200, { level: number; question: string; answer: string; success: boolean }> | ApiResponse<400, { success: boolean; error: string }> | ApiResponse<401, { success: boolean; error: string }> | ApiResponse<404, { success: boolean; error: string }> | ApiResponse<500, { success: boolean; error: string }>, never>
