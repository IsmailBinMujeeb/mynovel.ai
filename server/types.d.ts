...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'api.chapter.update': ApiRouteHandler<{ title: string; content: string; chapterNumber: number; chapterPrompt: string }, ApiResponse<200, { title: string; plot: string; coverPrompt: string; chapters: Array<{ _id: string; title: string; content: string; novelId: string; chapterPrompt: string; chapterNumber: number; isPrologue: boolean; isEpilogue: boolean; contentSummary: string }>; success: boolean }> | ApiResponse<400, { success: boolean; error: string }> | ApiResponse<401, { success: boolean; error: string }> | ApiResponse<500, { success: boolean; error: string }>, { topic: 'summarize.chapter'; data: never }>
    ...
    'api.chapter.delete': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { title: string; plot: string; coverPrompt: string; chapters: Array<{ _id: string; title: string; content: string; novelId: string; chapterPrompt: string; chapterNumber: number; isPrologue: boolean; isEpilogue: boolean; contentSummary: string }>; success: boolean }> | ApiResponse<400, { success: boolean; error: string }> | ApiResponse<401, { success: boolean; error: string }> | ApiResponse<500, { success: boolean; error: string }>, never>
    ...
    'auth.signup': ApiRouteHandler<{ email: string; password: string }, ApiResponse<201, { accessToken: string; refreshToken: string }> | ApiResponse<401, { error: string }> | ApiResponse<409, { error: string }> | ApiResponse<500, { error: string }>, { topic: 'create.new.user.credits'; data: never }>
    ...
    'auth.me': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { user: { id: string; email: string; username: string; avatar: string; createdAt: string; updatedAt: string } }> | ApiResponse<401, { error: string }> | ApiResponse<404, { error: string }> | ApiResponse<500, { error: string }>, never>
  }
